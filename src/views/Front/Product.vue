      ...
      <div class="col-lg-5 d-flex flex-column">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li
              class="breadcrumb-item active text-black-50 fw-bolder"
              aria-current="page"
            >
              {{ product.title }}
            </li>
            ...
            <div class="col-sm-5">
              <div class="mx-auto">
                <div class="row px-2">
                  ...
                  <input
                    class="col-6 button-count bg-transparent qty_input border-2 pt-1 text-center px-3"
            ...
            <div class="col-sm-7 px-0">
              <div class="row">
                <div class="col-md-6 px-4 px-sm-2">
                  <button
                    type="button"
                    class="ms-0 ms-sm-2 rounded-0 btn btn-primary text-white add-btn"
                ...
                <div class="col-md-6 px-4 ps-sm-1 pe-sm-2">
                  <button
                    type="button"
                    class="ms-0 ms-sm-2 rounded-0 btn btn-outline-primary text-primary add-btn add-favorite"
                    @click="addFavorite(product)"
                    :disabled="status.loadingItem === product.id"
                  >
                    <span v-if="JSON.stringify(myFavorite).includes(product.id)"
                      ><i class="bi bi-heart-fill p-0 h5"></i
                    ></span>
      ...
      <div class="tab-content" id="nav-tabContent">
        ...
        >
          <div class="teb-content mt-3 px-3">
            ...
            <p class="mt-1">
              當款項信用卡資料核對完後，該筆交易便完成付款，貨到付款則直接進行配送。<br />
              我們將會在付款完成後的 1 - 7
              個工作天內，將商品宅配送達您指定的收件地址。<br />
              為了保護商品的完整，請您收到貨後請立即開箱檢查，確認商品包裝完成無缺。
            </p>
          </div>
          ...
          <div class="teb-content mt-4 px-3">
            ...
            <p class="mt-1">
              台灣本島及離島若遇天候、海象、等不可控之因素，恕無法指定希望配達日及時段。
            </p>
          </div>
        </div>
        <div
        ...
        >
          <div class="teb-content mt-3 px-3">
            ...
            <p class="mt-1">
              ...
              <span class="pt-2"
                ><i class="bi bi-circle"></i
                >產品包裝內配件不齊全或商品規格與外包裝說明不符合<br
              /></span>
              <span class="pt-2"
                ><i class="bi bi-circle"></i
                >如商品超過鑑賞期欲辦理退換貨者，恕不受理</span
              >
            </p>
          </div>
        </div>
          ...
          <div class="card-body">
            ...
            >
              <span
                ...
                class="en-font h4 mask text-white text-center position-absolute"
              >
                see more
              </span>
            </div>
